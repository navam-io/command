...
This Streamlit multi-page app provides an interactive documentation landing page for Command. It showcases the features, capabilities, and benefits of Command through various interactive components and visualizations.
...
# Create and navigate to the command folder
mkdir command
cd command
...
echo "Command app setup complete!"
```
...
st.set_page_config(page_title="Command Documentation", page_icon="🤖", layout="wide")
...
def main():
    st.title("Command Documentation")
    ...
    st.markdown(
        """
        Welcome to the interactive documentation for Command! This app will guide you through the features, 
        capabilities, and benefits of Command, a powerful tool for supercharging your productivity and workflow 
    ...
    if selected == "Overview":
        ...
        st.markdown(
            """
            Command turns your Terminal into a configurable, interactive, and unobtrusive personal AI app. 
            With the power of 15 LLMs and 7 providers at your fingertips, Command integrates seamlessly with 
        ...
        with col2:
            ...
            st.markdown("Tailor Command to suit your specific workflow needs.")

    elif selected == "Commands":
        st.header("Command Commands")
        commands = {
            ...
            "command init": "Initialize Command in the current directory",
            "command config": "Edit the Command configuration",
            "command test": "Test Command commands across models and providers",
        }
        for cmd, desc in commands.items():
            st.markdown(f"**`{cmd}`**: {desc}")

    elif selected == "Workflows":
        st.header("Command Workflows")
        st.markdown(
            """
            Command supports various workflows to enhance your productivity:
        ...
        st.image("https://raw.githubusercontent.com/command/command/main/images/command-intents-workflow.webp")
...
def main():
    ...
    st.markdown(
        """
        Get started with Command in just a few simple steps:
        ...
        2. Initialize Command in your desired folder:
        ```bash
        command init
        ```
        ...
        That's it! You're now ready to use Command and explore its powerful features.
        """
    )
    ...
    st.code("command test ask", language="bash")
    st.code("command test vision", language="bash")
...
def main():
    st.title("Command Command Reference")

    commands = [
        ("ask", "Prompt the LLM for a fast, crisp response"),
        ("audit", "Analyze Command usage over time"),
        ("config", "Edit Command configuration"),
        ("gather", "Scrape and save webpage content as markdown"),
        ("id", "Identify current provider and model"),
        ("image", "Generate images based on prompts"),
        ("init", "Initialize Command in the current directory"),
        ...
        ("test", "Test Command commands across models and providers"),
...
def main():
    st.title("Command Workflows")

    st.markdown(
        """
        Command supports various workflows to enhance your productivity and creativity. Here are some key workflows:
        """
    )
    ...
    st.markdown(
        """
        Use Command to expand partial content, seed ideas, or incomplete notes into full-fledged articles, blog posts, or research papers.
        ...
        ```
        3. Command will process the content and generate an expanded version.
        """
    )
    ...
    st.markdown(
        ...
        ```
        3. Use the `command intents` command to generate content for specific intents:
        ```bash
        command intents "Your Template Name"
        ```
        """
    )
    st.image("https://raw.githubusercontent.com/command/command/main/images/command-intents-workflow.webp")
    ...
    st.markdown(
        ...
        ```bash
        command config ask model model_name
        ```
    ...
    st.markdown(
        ...
        ```bash
        command validate "Your Template Name"
        ```
        3. Command will provide a similarity score and highlight differences.
        """
    )
...
def main():
    ...
    st.markdown(
        """
        Command allows you to compare different models and providers easily. Use the `command test` command 
