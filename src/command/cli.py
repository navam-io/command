...
import command.action_intents as action_intents
import command.auditor as auditor
import command.code as code
import command.configure as configure
import command.evaluate as evaluate
import command.gather as gather_utils
import command.generate as generate
import command.markdown as markdown
import command.metrics as metrics
import command.model_text as model_text
import command.model_vision as model_vision
import command.reference as reference
import command.utils as utils
import command.validation as validation
from command.utils import trail
...
def init(force):
    click.echo("Initializing command in the current directory...")
    ...
    try:
        ...
        console.print(f"Initialized command in {current_dir}", style="bold green")
