...
This Streamlit app provides a user-friendly interface for scraping web articles and saving them as markdown files. It utilizes the `command.gather` module to perform the scraping functionality.
...
pip install streamlit command requests beautifulsoup4 html2text readability-lxml robotexclusionrulesparser markdown2 rich
...
import command.gather as gather
