...
from command.gather import article, article_scrape
...
@patch("command.gather.RobotExclusionRulesParser")
...
@patch("command.gather.requests.Session")
@patch("command.gather.RobotExclusionRulesParser")
...
@patch("command.gather.configure.load_config")
@patch("command.gather.article_scrape")
...
@patch("command.gather.requests.Session")
@patch("command.gather.RobotExclusionRulesParser")
@patch("command.gather.BeautifulSoup")
@patch("command.gather.Document")
@patch("command.gather.html2text.HTML2Text")
@patch("command.gather.os.path.exists")
@patch("command.gather.os.makedirs")
