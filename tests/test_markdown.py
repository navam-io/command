...
from command.markdown import (count_tokens, diff, extract_variables,
...
@patch("command.markdown.configure.load_config")
...
@patch("command.markdown.Console")
@patch("command.markdown.Prompt.ask")
...
@patch("command.markdown.Console")
@patch("command.markdown.Prompt.ask")
@patch("command.markdown.list_files")
