...
from command.bedrock import Bedrock
from command.claude import Claude
from command.gemini import Gemini
from command.groq import Groq
from command.ollama import Ollama
from command.openai import Openai
from command.perplexity import Perplexity
from command.utils import get_provider_instance, trail
...
def test_trail_decorator():
    ...
    with patch("command.utils.datetime", mock_datetime), patch(
        "command.utils.open", mock_open()
...
def test_trail_decorator_with_string_result():
    ...
    with patch("command.utils.open", mock_open()) as mock_file, patch(
        "yaml.dump"
